...
export const RECEIVE_SHOP_GOODS = 'receive_shop_goods' // 接收商品信息
export const RECEIVE_SHOP_RATINGS = 'receive_shop_ratings' // 接收商品评价

export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops' // 接收搜素商家列表

export const INCREMENT_FOOD_COUNT = 'increment_food_count' // 接收商品评价
export const DECREMENT_FOOD_COUNT = 'decrement_food_count' // 接收商品评价
