    ...
    <nav class="msite_nav">
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <!--{{newCategorys}}-->
          <div class="swiper-slide" v-for="(newcate,index) in newCategorys" :key="index" v-if="newCategorys.length">
            <a href="javascript:" class="link_to_food" v-for="(category,index) in newcate" :key="index">
