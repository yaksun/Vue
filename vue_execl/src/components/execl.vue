  ...
  <div id="chartpanel" class="row" data-equalizer>
    ...
    <div class="column small-12 left_panel" >
      ...
      <div id="chart_table">
        ...
        <charttable :proplabels="labels"> </charttable>
      </div>
    </div> <!-- end left panel -->
...
<script>
  import charttitle from './execllist/charttitle'
  import chartsubtitle from './execllist/chartsubtitle'
  import charttable from './execllist/charttable'
export default{
   name:'execl',
  components:{
    charttitle,
